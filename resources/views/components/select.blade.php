<div class="block relative w-40 max-w-full dropdown">
    <input
        ...
        {{ $attributes }}
    />
    <div class="absolute z-99 top-4 right-2 transition-all z-10" id="icon-selector">
    ...
    <ul class="shadow bg-gray-50 rounded hidden absolute top-14 right-0 z-20 w-full" id="dropdown-item">
        {{ $slot }}
    </ul>
</div>
@push('scripts')
